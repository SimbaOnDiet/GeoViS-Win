;;----------------------------------------------------------------------
;; This is an example for Einstein's Eye which is witten for Mueller's 
;; GeoVis, some necessary modifications were made to suit for Einstein's
;; eye.
;;
;; modified and redistributed by Liang Yien, this file was modified for 
;; presentation in the (undergraduate) Optics course.
;;
;; Thanks to Mueller for his effort made on this file.
;; ---------------------------------------------------------------------
...
(define bg_image_up    ("milkwayimg.ppm"))
(define bg_image_down  ("allblack.ppm"))
