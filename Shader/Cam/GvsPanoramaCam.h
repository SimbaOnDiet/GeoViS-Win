...
//  along with GeoViS.  If not, see <http://www.gnu.org/licenses/>.
// ---------------------------------------------------------------------
#ifndef GVS_PANORAMA_CAM_H
#define GVS_PANORAMA_CAM_H
...
/**
 * @brief The panorama camera is a compromise between the pinhole camera
 *        and the 4pi camera.
 */
class GvsPanoramaCam : public GvsCamera
{
public:
    GvsPanoramaCam();
    GvsPanoramaCam(const m4d::vec3 &dir, const m4d::vec3 &vup, const m4d::vec2 &fov, const m4d::ivec2 &res);
    virtual ~GvsPanoramaCam();

    void   setViewDirection ( const m4d::vec3 &dir );
    void   setViewUpVector  ( const m4d::vec3 &vup );

    void   setFieldOfView   ( const m4d::vec2 &fov );  //!< Set field of view in degrees.
...
private:
    ...
    m4d::vec3    viewHorizDir;
    m4d::vec3    viewVertDir;
