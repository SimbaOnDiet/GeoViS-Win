 ...
 */
bool 
MetricReissnerNordstrom :: calculateMetric  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricReissnerNordstrom :: calculateChristoffels  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricReissnerNordstrom :: calculateChrisD ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricReissnerNordstrom :: localToCoord   ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricReissnerNordstrom :: coordToLocal   ( const double* pos, const double* cdir, double* ldir, 
                                            enum_nat_tetrad_type   )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricReissnerNordstrom :: breakCondition ( const double* pos)
{
  if (pos[1]<=0.0)
    return true;
 ...
 */
bool 
MetricReissnerNordstrom :: calcDerivs ( const double y[], double dydx[] )
{
  dydx[0] = y[4];
  dydx[1] = y[5];
  dydx[2] = y[6];
 ...
 */
double 
MetricReissnerNordstrom :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
  double st    = sin(theta);
 ...
 */
bool 
MetricReissnerNordstrom :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricReissnerNordstrom :: transToEmbedding ( vec4 p, vec4 &ep )
{
  vec4 cp;
 ...
 */
bool
MetricReissnerNordstrom :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool
MetricReissnerNordstrom :: testEmbeddingParams  ( )
{
  bool allOk = true;
  if (mEmb_rmin<rp)
  {
 ...
 */
int
MetricReissnerNordstrom :: getEmbeddingVertices ( std::vector<vec3> &verts,
 ...
 */
bool
MetricReissnerNordstrom :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricReissnerNordstrom :: totEnergy ( const vec4 pos, const vec4 cdir, const double , double &val )
{
 ...
 */
void
MetricReissnerNordstrom :: usePhysicalUnits ( const enum_physical_constants  units )
{
 ...
 */
void
MetricReissnerNordstrom :: setUnits ( const double speed_of_light, const double grav_const, const double diel_perm )
{
 ...
 */
bool    
MetricReissnerNordstrom :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
bool
MetricReissnerNordstrom :: calcKsiCrit ( const vec4 pos, double &ksicrit, double B )
{
 ...
 */
bool
MetricReissnerNordstrom :: calcRadiusIsco ( double &radiusIsco, double B )
{
    if (B<=0.25)
    {
 ...
 */
bool
MetricReissnerNordstrom :: calcRadiusIsco2 ( double &radiusIsco2, double B )
{
    if (B>0.25 && B<0.3125)
    {
 ...
 */
bool
MetricReissnerNordstrom :: calcRadiusIuco ( double &radiusIuco, double B )
{
    if (B>0.28125 && B<0.3125)
    {
        double w1 = sqrt(1.-3.*B);
 ...
 */
bool
MetricReissnerNordstrom :: calcBetaCo ( double &betaCo, double radiusCo, double B )
{
 ...
 */
void 
MetricReissnerNordstrom :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 3.0*rs;
  mInitPos[2] = M_PI_2;
 ...
 */
void 
MetricReissnerNordstrom :: calcDiskr ( )
{
 ...
 */
void
MetricReissnerNordstrom :: calcCritical ( )
{
  if (mDiskr<0.0)
  {
    rp = rm = 0.0;
 ...
 */
void
MetricReissnerNordstrom :: calcExtremals ( )
{
 ...
 */
bool
MetricReissnerNordstrom :: calcEmbeddingZ ( const double r, double &z )
{
