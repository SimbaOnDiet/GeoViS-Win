 ...
 */
bool 
MetricJaNeWi :: calculateMetric  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricJaNeWi :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricJaNeWi :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
void
MetricJaNeWi :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricJaNeWi :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                               enum_nat_tetrad_type   )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricJaNeWi :: breakCondition ( const double* pos)
{
    bool br = false;

    if ((pos[1]<0.0) || (mGamma*mGamma*pos[1]*pos[1]<=(1.0+eps)*rs*rs) || pos[1]<mCritPoint) { br=true; }
    return br;
}
 ...
 */
bool 
MetricJaNeWi :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricJaNeWi :: transToEmbedding ( vec4 p, vec4 &ep )
{
    vec4 cp;
 ...
 */
bool
MetricJaNeWi :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool   
MetricJaNeWi :: testEmbeddingParams  ( )
{
    bool allOk = true;
 ...
 */
int    
MetricJaNeWi :: getEmbeddingVertices ( std::vector<vec3> &verts,  
 ...
 */
bool
MetricJaNeWi :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
    double kappa = 0.0;
 ...
 */
bool
MetricJaNeWi :: totEnergy ( const vec4 pos, const vec4 cdir, const double , double &val )
{
 ...
 */
bool    
MetricJaNeWi :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
    std::stringstream ss;
 ...
 */
void    
MetricJaNeWi :: calcCriticalPoint ( )
{
...
bool
MetricJaNeWi :: calcEmbeddingZ ( const double r, double &z )
{
 ...
 */
double
MetricJaNeWi :: getCircularVelocity( const double r, const enum_nat_tetrad_type  )
{
 ...
 */
void 
MetricJaNeWi :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 3.0*rs;
    mInitPos[2] = M_PI_2;
