 ...
 *
 */
MetricPTD_AIII :: MetricPTD_AIII ()
{
  mMetricName  = "Petrov_Type_D_AIII_ES";
 ...
 */
bool
MetricPTD_AIII :: calculateMetric  ( const double* pos )
{
    double r     = pos[1];
    double z     = pos[3];

    double t2 = 1;//mSpeedOfLight*mSpeedOfLight;
    double t4 = z*z;
    double t5 = r*r;
    g_compts[0][0] = -1/z*t2;
    g_compts[0][1] = 0.0;
 ...
 */
bool
MetricPTD_AIII :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];

    double t1 = z*z;
    double t4 = 1;//mSpeedOfLight*mSpeedOfLight;
    double t7 = 1/z;
    double t8 = t7/2.0;
    double t9 = 1/r;
    double t10 = r*r;
    ...
    christoffel[0][0][3] = -1/t1/z*t4/2.0;
    ...
    christoffel[1][2][2] = t9;
    christoffel[1][2][3] = 0.0;
    christoffel[1][3][0] = 0.0;
    christoffel[1][3][1] = t7;
 ...
 */
bool
  MetricPTD_AIII :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];
 ...
 */
void
MetricPTD_AIII :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPTD_AIII :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type )
{
    double r  = pos[1];
    double z  = pos[3];
 ...
 */
bool
MetricPTD_AIII :: breakCondition ( const double* pos)
{
    bool br = false;

    if (pos[3]*pos[3]<=(0.0+eps)) { br=true; }
    return br;
}
 ...
 */
double
MetricPTD_AIII :: testConstraint ( const double y[], const double kappa )
{
    double r     = y[1];
    double z = y[3];
    double cm = 1.0;
    ...
    double sum = -kappa;
    sum += -dt*dt/z + z*dz*dz + z*z*(dr*dr + r*r*dph*dph);
    return sum;
}
 ...
 */
bool
MetricPTD_AIII :: setParam ( std::string,  double )
{
  return true;
}
 ...
 */
bool
MetricPTD_AIII :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
void
MetricPTD_AIII :: setStandardValues( )
{
  mInitPos[0] = 0.0;
  mInitPos[1] = 1.0;
  mInitPos[2] = 0.0;
