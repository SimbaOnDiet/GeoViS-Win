 ...
 */
bool 
MetricStraightSpinningString :: calculateMetric  ( const double* pos )
{
  double rho = pos[1];
 ...
 */
bool 
MetricStraightSpinningString :: calculateChristoffels  ( const double* pos )
{
  double rho = pos[1];
 ...
 */
bool 
MetricStraightSpinningString :: calculateChrisD ( const double* pos )
{
  double rho = pos[1];
 ...
 */
void
MetricStraightSpinningString :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricStraightSpinningString :: coordToLocal ( const double* , const double* , double* ,
 ...
 */
bool 
MetricStraightSpinningString :: breakCondition ( const double* )
{
  bool br = false;
  return br;
}
 ...
 */
bool
MetricStraightSpinningString :: calcDerivs ( const double y[], double dydx[] )
{
  dydx[0] = y[4];
  dydx[1] = y[5];
  dydx[2] = y[6];
 ...
 */
bool 
MetricStraightSpinningString :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricStraightSpinningString :: effPotentialValue  ( const vec4 pos, const vec4 cdir, enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricStraightSpinningString :: totEnergy ( const vec4 , const vec4 cdir, const double , double &val )
{
  double c = mSpeedOfLight;
  double h1 = c*(c*cdir[0] - mA*cdir[2]);
 ...
 */
bool    
MetricStraightSpinningString :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricStraightSpinningString :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 6.0;
  mInitPos[2] = 0.0;
...
void
MetricStraightSpinningString :: calcClosestApproach ( const double* pos, const double* ldir )
{
