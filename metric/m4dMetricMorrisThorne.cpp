 ...
 */
bool 
MetricMorrisThorne :: calculateMetric  ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricMorrisThorne :: calculateChristoffels  ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricMorrisThorne :: calculateChrisD ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
 ...
 */
void
MetricMorrisThorne :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricMorrisThorne :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                     enum_nat_tetrad_type   )
{
    double w = sqrt(mb0*mb0 + pos[1]*pos[1]);
 ...
 */
bool 
MetricMorrisThorne :: breakCondition ( const double* )
{
    bool br = false;
    return br;
}
 ...
 */
bool 
MetricMorrisThorne :: calcDerivs ( const double y[], double dydx[] )
{
    dydx[0] = y[4];
    dydx[1] = y[5];
    dydx[2] = y[6];
 ...
 */
double 
MetricMorrisThorne :: testConstraint ( const double y[], const double kappa )
{
    double l  = y[1];
 ...
 */
bool 
MetricMorrisThorne :: setParam ( std::string pName, double val )
{
 ...
 */
bool  
MetricMorrisThorne :: transToEmbedding ( vec4 p, vec4 &ep )
{
    if (mb0<=0.0)
        return false;
 ...
 */
bool    
MetricMorrisThorne :: transToCustom ( vec4 , vec4& )
{
    //  TODO
    return false;
}
 ...
 */
bool
MetricMorrisThorne :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
int    
MetricMorrisThorne :: getEmbeddingVertices ( std::vector<vec3> &verts,  
 ...
 */
bool
MetricMorrisThorne :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
    double kappa = 0.0;
 ...
 */
bool
MetricMorrisThorne :: totEnergy ( const vec4 , const vec4 cdir, const double , double &val )
{
    // 1/2*k^2/c^2:
 ...
 */
bool    
MetricMorrisThorne :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
    std::stringstream ss;
 ...
 */
bool
MetricMorrisThorne :: calcKsiCrit ( const vec4 pos, double &ksicrit )
{
    double l = pos[1];
 ...
 */
bool
MetricMorrisThorne :: constsOfMotion  ( const vec4 pos, const vec4 cdir, double &k, double &h )
{
 ...
 */
void 
MetricMorrisThorne :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 10.0;
    mInitPos[2] = M_PI_2;
