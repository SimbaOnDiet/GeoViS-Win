 ...
 */
bool 
MetricBesselGravWaveCart :: calculateMetric  ( const double* pos )
{
  double t = pos[0];
  double x = pos[1];
  double y = pos[2];
 ...
 */
bool 
MetricBesselGravWaveCart :: calculateChristoffels  ( const double* pos )
{
  double t = pos[0];
  double x = pos[1];
  double y = pos[2];
 ...
 */
bool
MetricBesselGravWaveCart :: calculateChrisD ( const double* pos )
{
  double t = pos[0];
  double x = pos[1];
  double y = pos[2];
 ...
 */
void
MetricBesselGravWaveCart :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricBesselGravWaveCart :: coordToLocal ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type   )
{
  calcLTcoeffs(pos);
 ...
 */
bool 
MetricBesselGravWaveCart :: breakCondition ( const double*  )
{
  bool br = false;
 ...
 */
double 
MetricBesselGravWaveCart :: testConstraint ( const double Y[], const double kappa )
{
 ...
 */
bool 
MetricBesselGravWaveCart :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricBesselGravWaveCart :: transToTwoPlusOne  ( vec4 p, vec4 &cp )
{
  vec4 tp;
 ...
 */
bool    
MetricBesselGravWaveCart :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricBesselGravWaveCart :: setStandardValues ()
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 0.0;
  mInitPos[2] = 0.0;
 ...
 */
void
MetricBesselGravWaveCart :: calcLTcoeffs ( const double* pos )
{
  double t = pos[0];
  double x = pos[1];
  double y = pos[2];
