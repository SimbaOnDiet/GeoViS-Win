 ...
 */
bool
MetricPTD_BIII :: calculateMetric  ( const double* pos )
{
  double r     = pos[1];
  double z     = pos[3];
 ...
 */
bool
MetricPTD_BIII :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];
    double  t1 = r*r;
 ...
 */
bool
  MetricPTD_BIII :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];
    double t2 = r*r;
 ...
 */
void
MetricPTD_BIII :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPTD_BIII :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type )
{
    double r  = pos[1];
    double z  = pos[3];
 ...
 */
bool
MetricPTD_BIII :: breakCondition ( const double* pos)
{
    bool br = false;
 ...
 */
bool
MetricPTD_BIII :: setParam ( std::string,  double )
{
  return true;
}
 ...
 */
bool
MetricPTD_BIII :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
void
MetricPTD_BIII :: setStandardValues( )
{
  mInitPos[0] = 0.0;
  mInitPos[1] = 6.0;
  mInitPos[2] = 0.0;
