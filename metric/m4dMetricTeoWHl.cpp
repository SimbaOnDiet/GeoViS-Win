 ...
 */
bool 
MetricTeoWHl :: calculateMetric  ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
    double c = 1.0;
 ...
 */
bool 
MetricTeoWHl :: calculateChristoffels  ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
    double c = 1.0;
 ...
 */
bool 
MetricTeoWHl :: calculateChrisD ( const double* pos )
{
    double l     = pos[1];
    double theta = pos[2];
    double c = 1.0;
 ...
 */
void
MetricTeoWHl :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricTeoWHl :: coordToLocal ( const double* , const double* , double* ,
 ...
 */
bool 
MetricTeoWHl :: breakCondition ( const double* ) {
    bool br = false;
    return br;
}
 ...
 */
bool 
MetricTeoWHl :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricTeoWHl :: report ( const vec4 , const vec4 , std::string &text )
{
    std::stringstream ss;
 ...
 */
void 
MetricTeoWHl :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 10.0;
    mInitPos[2] = M_PI_2;
 ...
 */
double 
MetricTeoWHl :: calc_d2r ( double l )
{
 ...
 */
double 
MetricTeoWHl :: calc_omega ( double l )
{
    double r = calc_r(l);
 ...
 */
double 
MetricTeoWHl :: calc_domega ( double l )
{
 ...
 */
double 
MetricTeoWHl :: calc_d2omega ( double  )
{
    return 0.0;
}
