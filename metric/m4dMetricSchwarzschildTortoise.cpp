 ...
 */
bool 
MetricSchwarzschildTortoise :: calculateMetric  ( const double* pos )
{
  double rho   = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschildTortoise :: calculateChristoffels  ( const double* pos )
{
  double rho   = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschildTortoise :: calculateChrisD ( const double* pos )
{
  double rho   = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricSchwarzschildTortoise :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricSchwarzschildTortoise :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                              enum_nat_tetrad_type  )
{
  double rho   = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschildTortoise :: breakCondition ( const double* )
{
  bool br = false;
  return br;
}
 ...
 *
bool 
MetricSchwarzschildTortoise :: calcDerivs ( const double y[], double dydx[] )
{
  dydx[0] = y[4];
  dydx[1] = y[5];
  dydx[2] = y[6];
 ...
 */
double 
MetricSchwarzschildTortoise :: testConstraint ( const double y[], const double kappa )
{
  double rho   = y[1];
  double theta = y[2];
 ...
 */
bool   
MetricSchwarzschildTortoise :: calcProduct ( const double* pos, const double* u, const double* v, double &prod, bool )
{
  prod = 0.0;
 ...
 */
bool 
MetricSchwarzschildTortoise :: setParam ( std::string pName, double val )
{
 ...
 */
bool  
MetricSchwarzschildTortoise :: transToEmbedding ( vec4 p, vec4 &ep )
{
  vec4 cp;
 ...
 */
bool
MetricSchwarzschildTortoise :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool   
MetricSchwarzschildTortoise :: testEmbeddingParams  ( )
{
  bool allOk = true;
  if (mEmb_rmin<rs)
  {
 ...
 */
int    
MetricSchwarzschildTortoise :: getEmbeddingVertices ( std::vector<vec3> &verts,  
 ...
 */
bool    
MetricSchwarzschildTortoise :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricSchwarzschildTortoise :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 1.0;
  mInitPos[2] = M_PI_2;
 ...
 */
double 
MetricSchwarzschildTortoise :: calc_r ( const double rho )
{
