 ...
 */
bool 
MetricEddFinkIn :: calculateMetric  ( const double* pos )
{  
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricEddFinkIn :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool
MetricEddFinkIn :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
void
MetricEddFinkIn :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricEddFinkIn :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                  enum_nat_tetrad_type  type )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricEddFinkIn :: breakCondition ( const double* pos)
{
    bool br = false;
 ...
 */
bool
MetricEddFinkIn :: calcDerivsSachsJacobi ( const double y[], double dydx[] )
{
 ...
 */
double 
MetricEddFinkIn :: testConstraint ( const double y[], const double kappa )
{
    double r     = y[1];
    double theta = y[2];
 ...
 */
bool 
MetricEddFinkIn :: setParam ( std::string pName, double val )
{
 ...
 */
void   
MetricEddFinkIn :: usePhysicalUnits ( const enum_physical_constants  units )
{
 ...
 */
void   
MetricEddFinkIn :: setUnits ( const double speed_of_light, const double grav_const, const double diel_perm )
{
 ...
 */
bool    
MetricEddFinkIn :: report ( const vec4 , const vec4 , std::string &text )
{
    std::stringstream ss;
 ...
 */
void 
MetricEddFinkIn :: setStandardValues ( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 3.0*rs;
    mInitPos[2] = M_PI_2;
 ...
 */
void
MetricEddFinkIn :: contrChrisVecVec  ( const double y[], const double u[], const double w[], double* z, bool )
{
    double r     = y[1];
    double theta = y[2];
 ...
 */
void
MetricEddFinkIn :: contrChrDVecVecVec ( const double y[], const double u[], const double v[], const double w[], double* z, bool )
{
    double r     = y[1];
    double theta = y[2];
