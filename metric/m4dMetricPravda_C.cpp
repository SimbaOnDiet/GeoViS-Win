 ...
 */
bool
MetricPravda_C :: calculateMetric  ( const double* pos )
{
  double x = pos[1];
  double y = pos[2];
  double A = Par_A;
 ...
 */
bool
MetricPravda_C :: calculateChristoffels  ( const double* pos )
{
    double x = pos[1];
    double y = pos[2];
    double A = Par_A;
 ...
 */
void
MetricPravda_C :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPravda_C :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type )
{
    double x = pos[1];
    double y = pos[2];
 ...
 */
bool
MetricPravda_C :: breakCondition ( const double* )
{
    bool br = false;
    return br;
}
 ...
 */
double
MetricPravda_C :: testConstraint ( const double y[], const double kappa )
{
    calculateMetric(y);
 ...
 */
bool
MetricPravda_C :: setParam ( std::string pName, double val )
{
  Metric::setParam(pName,val);
  if (pName=="m") Par_m = val;
  if (pName=="a") Par_A = val;
  return true;
}
 ...
 */
bool
MetricPravda_C :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void
MetricPravda_C :: setStandardValues( )
{
  mInitPos[0] = 0.0;
  mInitPos[1] = -5.0;
  mInitPos[2] = -5.0;
