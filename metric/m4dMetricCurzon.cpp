 ...
 */
bool 
MetricCurzon :: calculateMetric  ( const double* pos )
{
    double r = pos[1];
    double lambda,nu;
 ...
 */
bool 
MetricCurzon :: calculateChristoffels  ( const double* pos )
{
    double r = pos[1];
 ...
 */
bool 
MetricCurzon :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double m = mMass;
    double z = pos[3];
 ...
 */
void
MetricCurzon :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricCurzon :: coordToLocal ( const double* , const double* , double* ,
                               enum_nat_tetrad_type   )
{
    // double r     = pos[1];
    // double theta = pos[2];
 ...
 */
bool 
MetricCurzon :: breakCondition ( const double* pos)
{
    bool br = false;
 ...
 */
double 
MetricCurzon :: testConstraint ( const double y[], const double kappa )
{
    double r     = y[1];
 ...
 */
bool 
MetricCurzon :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricCurzon :: report ( const vec4 , const vec4 , std::string &text )
{
    std::stringstream ss;
 ...
 */
void 
MetricCurzon :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 6.0;
    mInitPos[2] = 0.0;
 ...
 */
double
MetricCurzon :: calcR ( const double* pos )
{
    double r = pos[1];
    double z = pos[3];
    return sqrt(r*r+z*z);
 ...
 */
void
MetricCurzon :: calcLambdaNu ( const double* pos, double &lambda, double &nu )
{
    double r = pos[1];
    double R = calcR(pos);
...
void
MetricCurzon :: calcDLN ( const double* pos, double &lambda, double &nu, double &,
