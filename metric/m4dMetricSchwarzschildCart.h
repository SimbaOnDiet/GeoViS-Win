...
#ifndef M4D_METRIC_SCHWARZSCHILD_CART_H
#define M4D_METRIC_SCHWARZSCHILD_CART_H
...
// ---------------------------------------------------
class MetricSchwarzschildCart : public Metric
{
 public:
  //! Standard constructor for the Schwarzschildcart.
  MetricSchwarzschildCart ( double mass = 1.0 );
  virtual ~MetricSchwarzschildCart (); 
