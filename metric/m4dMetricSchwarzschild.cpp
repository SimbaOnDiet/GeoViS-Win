 ...
 */
bool 
MetricSchwarzschild :: calculateMetric  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschild :: calculateChristoffels  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschild :: calculateChrisD ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool   
MetricSchwarzschild :: calculateRiemann ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool  
MetricSchwarzschild :: calculateWeyl ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschild :: calculateRicRotCoeffs ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschild :: calculateContrRRC ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricSchwarzschild :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricSchwarzschild :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                      enum_nat_tetrad_type  )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricSchwarzschild :: breakCondition ( const double* pos)
{
  bool br = false;
  
  if ((pos[1]<0.0) || (pos[1]*pos[1]<=(1.0+eps)*rs*rs)) { br=true; }
  return br;
}
 ...
 */
bool
MetricSchwarzschild :: calcDerivs ( const double y[], double dydx[] )
{
  dydx[0] = y[4];
  dydx[1] = y[5];
  dydx[2] = y[6];
 ...
 */
bool
MetricSchwarzschild :: calcDerivsPar  ( const double y[], double dydx[] )
{    
  calcDerivs(y,dydx);
 ...
 */
bool   
MetricSchwarzschild :: calcDerivsSachsJacobi ( const double y[], double dydx[] )
{ 	
 ...
 */
bool 
MetricSchwarzschild :: calcDerivsFW ( const double a[], const double y[], double dydx[] )
{
  //return false;
  dydx[0] = y[4];
  dydx[1] = y[5];
 ...
 */
double 
MetricSchwarzschild :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
bool   
MetricSchwarzschild :: calcProduct ( const double* pos, const double* u, const double* v, double &prod, bool )
{
  prod = 0.0;
 ...
 */
bool 
MetricSchwarzschild :: setParam ( std::string pName, double val )
{
 ...
 */
bool  
MetricSchwarzschild :: transToEmbedding ( vec4 p, vec4 &ep )
{
  vec4 cp;
 ...
 */
bool    
MetricSchwarzschild :: transToTwoPlusOne  ( vec4 p, vec4 &cp )
{
  vec4 tp;
 ...
 */
bool    
MetricSchwarzschild :: transToCustom ( vec4 p, vec4 &cp )
{
  double r = p[1];
  double phi = p[3];
 ...
 */
bool
MetricSchwarzschild :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool   
MetricSchwarzschild :: testEmbeddingParams  ( )
{
  bool allOk = true;
  if (mEmb_rmin<rs)
  {
 ...
 */
int    
MetricSchwarzschild :: getEmbeddingVertices ( std::vector<vec3> &verts,  
 ...
 */
bool
MetricSchwarzschild :: effPotentialValue  ( const vec4 pos, const vec4 cdir, enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricSchwarzschild :: totEnergy ( const vec4 pos, const vec4 cdir, const double , double &val )
{
  if (pos[1]<rs+1e-2)
      return false;
 ...
 */
double
MetricSchwarzschild :: getCircularVelocity( const double r, const enum_nat_tetrad_type  )
{
    if (r>=3.0*rs) {
 ...
 */
void   
MetricSchwarzschild :: usePhysicalUnits ( const enum_physical_constants  units )
{
 ...
 */
void   
MetricSchwarzschild :: setUnits ( const double speed_of_light, const double grav_const, const double diel_perm )
{
 ...
 */
bool    
MetricSchwarzschild :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
bool
MetricSchwarzschild :: calcKsiCrit ( const vec4 pos, double &ksicrit )
{
  if (pos[1]<rs)
    return false;
 ...
 */
void 
MetricSchwarzschild :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 3.0*rs;
  mInitPos[2] = M_PI_2;
 ...
 */
void
MetricSchwarzschild :: contrChrisVecVec  ( const double y[], const double u[], const double w[], double* z, bool calc )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
void  
MetricSchwarzschild :: contrChrDVecVecVec ( const double y[], const double u[], const double v[], const double w[], double* z, bool calc )
{
  double r     = y[1];
  double theta = y[2];
