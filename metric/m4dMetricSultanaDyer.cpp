 ...
 */
bool
MetricSultanaDyer :: calculateMetric ( const double* pos )
{
  double t     = pos[0];
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool
MetricSultanaDyer :: calculateChristoffels ( const double* pos )
{
  double t     = pos[0];
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool
MetricSultanaDyer :: calculateChrisD ( const double* pos )
{
  double t     = pos[0];
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricSultanaDyer :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricSultanaDyer :: coordToLocal ( const double* pos, const double* cdir, double* ldir,
                                    enum_nat_tetrad_type type )
{
  double t     = pos[0];
  double r     = pos[1];
 ...
 */
bool
MetricSultanaDyer :: breakCondition ( const double* pos )
{
  bool br = false;
 ...
 */
bool
MetricSultanaDyer :: setParam ( std::string pName, double val )
{
 ...
 */
double
MetricSultanaDyer :: testConstraint ( const double y[], const double kappa )
{
  double t      = y[0];
  double r      = y[1];
  double theta  = y[2];
 ...
 */
bool
MetricSultanaDyer :: report ( const vec4, const vec4, std::string &text )
{
  std::stringstream ss;
 ...
 */
void
MetricSultanaDyer :: setStandardValues ()
{
  mInitPos[0] = 1.0;
  mInitPos[1] = 6.0;
  mInitPos[2] = M_PI_2;
