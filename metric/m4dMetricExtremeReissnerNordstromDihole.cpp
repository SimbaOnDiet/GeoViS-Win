 ...
 */
bool 
MetricExtremeReissnerNordstromDihole :: calculateMetric  ( const double* pos )
{
 ...
 */
bool 
MetricExtremeReissnerNordstromDihole :: calculateChristoffels  ( const double* pos )
{
  double t1 = calc_U(pos);  // U(x,y,z);
  double Ux,Uy,Uz;
 ...
 */
bool 
MetricExtremeReissnerNordstromDihole :: calculateChrisD ( const double* pos )
{
  double U = calc_U(pos);
 ...
 */
void
MetricExtremeReissnerNordstromDihole :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricExtremeReissnerNordstromDihole :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                                       enum_nat_tetrad_type )
{
  double U = calc_U(pos);
 ...
 */
bool 
MetricExtremeReissnerNordstromDihole :: breakCondition ( const double* )
{
  bool br = false;
 ...
 */
double 
MetricExtremeReissnerNordstromDihole :: testConstraint ( const double y[], const double kappa )
{
  double U = calc_U(y);
 ...
 */
bool 
MetricExtremeReissnerNordstromDihole :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: transToTwoPlusOne  ( vec4 p, vec4 &cp )
{
  double x = p[1];
  double y = p[2];
  double z = p[3];
 ...
 */
bool    
MetricExtremeReissnerNordstromDihole :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcEscapeVelocityAlongZ ( const vec4 pos, double &betaEscape, double m1, double m2 )
{
    double z = pos[3];
    double w1,w2;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcEscapeVelocityAlongX ( const vec4 pos, double &betaEscape, double MASS )
{
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcPointOfEquilibrium ( double &pointOfEquilibrium )
{
    if ( mM1==mM2 )
    {
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcASingularityPoint ( double &singularityPoint )
{
    double q = mM1/mM2;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcVelocityToEquilibriumPoint ( const vec4 pos, double &betaEquilibrium, double pointOfEquilibrium, double mass1, double mass2 )
{
    double z0 = pos[3];
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcPeriodicAlongX ( const vec4 pos, double &periodicAlongX, double MASS )
{
    double x0 = pos[1];
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcVelocityAtOriginAlongX ( const vec4 pos, double &betaAtOriginAlongX, double MASS )
{
    double xSquare = pos[1]*pos[1];
    double w1 = xSquare+1.;
    double w2 = 1.+2.*MASS;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcPhotOrbitsXY ( double &r_Nm, double &r_Np, double mquer )
{
    if ( mM1>=mquer )
    {
        double m = mM1*mM1;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcKsiCritXY ( const vec4 pos, double &ksicritXY, double r_Np, double MASS)
{
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcRadiusIscoXY ( double &radiusIscoXY, double MASS )
{
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcRadiusIucoXY ( double &radiusIucoXY, double MASS )
{
    double mstern = 1.0294905868123894;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcBetaCoXY ( double &betaCoXY, double radiusCoXY )
{
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcRadiusForOtherCo ( double &radiusForOtherCo, double z)
{
    double w1 = 1. + z;
    double w2 = 1. - z;
    double w3 = w1*w1;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcRadiusForOtherCoForUnequalMasses ( double &radiusForOtherCo, double z, double M1, double M2 )
{
    double w1 = 1. + z;
    double w2 = 1. - z;
    double w3 = w1*w1;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcHeightOfOtherPhotonOrbits ( double &heightOfOtherPhotonOrbits, double M)
{
     //int status;
     const gsl_root_fdfsolver_type *T;
     gsl_root_fdfsolver *s;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcVelocityForOtherTimelikeCo ( const vec4 pos, double &betaTimelike, double M )
{
      double rho;
      double z = pos[3];
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcHeightOfOtherPhotonOrbitsForUnequalMasses ( double &heightOfOtherPhotonOrbits1, double &heightOfOtherPhotonOrbits2, double M1, double M2 )
{
      //int status;
 ...
 */
bool
MetricExtremeReissnerNordstromDihole :: calcVelocityForOtherTimelikeCoForUnequalMasses ( const vec4 pos, double &betaTimelike, double M1, double M2 )
{
        double rho;
        double z = pos[3];
 ...
 */
void 
MetricExtremeReissnerNordstromDihole :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 10.0;
  mInitPos[2] = 0.0;
...
void 
MetricExtremeReissnerNordstromDihole :: calc_r ( const double y[] )
{
...
double 
MetricExtremeReissnerNordstromDihole :: calc_U  ( const double y[] )
{  
  calc_r(y);
...
void 
MetricExtremeReissnerNordstromDihole :: calc_dU ( const double y[], double &Ux, double &Uy, double &Uz )
{
  double xx = y[1];
  double yy = y[2];
  double zz = y[3];
...
void 
MetricExtremeReissnerNordstromDihole :: calc_ddU ( const double y[], double &Uxx, double &Uyy, double &Uzz,
