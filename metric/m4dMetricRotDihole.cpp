 ...
 */
bool 
MetricRotDihole :: calculateMetric  ( const double* pos )
{
    double U = calc_U(pos);
 ...
 */
bool 
MetricRotDihole :: calculateChristoffels  ( const double* pos )
{
 ...
 */
bool 
MetricRotDihole :: calculateChrisD ( const double*  )
{
 ...
 */
void
MetricRotDihole :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricRotDihole :: coordToLocal ( const double* pos, const double* cdir, double* ldir,
                               enum_nat_tetrad_type   )
{
    double U = calc_U(pos);
 ...
 */
bool 
MetricRotDihole :: breakCondition ( const double* )
{
  bool br = false;
  return br;
}
 ...
 */
bool 
MetricRotDihole :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricRotDihole :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricRotDihole :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 10.0;
    mInitPos[2] = 0.0;
...
void
MetricRotDihole :: calc_r ( const double *pos, double &r1, double &r2 )
{
    double t = pos[0];
    double x = pos[1];
    double y = pos[2];
...
double
MetricRotDihole :: calc_U  (const double *pos )
{
    double r1,r2;
    calc_r(pos,r1,r2);
...
void
MetricRotDihole :: calc_dU ( const double *pos, double &dUdt, double &dUdx, double &dUdy, double &dUdz )
{
    double t = pos[0];
    double x = pos[1];
    double y = pos[2];
