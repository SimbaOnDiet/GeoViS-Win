 ...
 */
bool 
MetricAlcubierre :: calculateMetric  ( const double* pos )
{
 ...
 */
bool 
MetricAlcubierre :: calculateChristoffels  ( const double* pos )
{
    double c = mSpeedOfLight;
    double v = mvs;
 ...
 */
bool 
MetricAlcubierre :: calculateChrisD ( const double* pos )
{
    double c = mSpeedOfLight;
    double v = mvs;
 ...
 */
bool
MetricAlcubierre :: calculateRiemann ( const double* pos )
{
    double c = mSpeedOfLight;
    double v = mvs;
 ...
 */
void
MetricAlcubierre :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricAlcubierre :: coordToLocal   ( const double* pos, const double* cdir, double* ldir, 
                                     enum_nat_tetrad_type  type )
{
    double f = calcF(pos);
    double c = mSpeedOfLight;
 ...
 */
bool 
MetricAlcubierre :: breakCondition ( const double* )
{
    bool br = false;
 ...
 */
bool
MetricAlcubierre :: calcDerivs ( const double y[], double dydx[] )
{
    dydx[0] = y[4];
    dydx[1] = y[5];
    dydx[2] = y[6];
 ...
 */
double 
MetricAlcubierre :: testConstraint ( const double y[], const double kappa )
{
    double c = mSpeedOfLight;
    double f = calcF(y);
 ...
 */
bool
MetricAlcubierre :: resize ( double* y, double kappa, double factor )
{
    double f = calcF(y);
    double z = mvs*f;
 ...
 */
bool 
MetricAlcubierre :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricAlcubierre :: transToTwoPlusOne  ( vec4 p, vec4 &cp )
{
 ...
 */
bool    
MetricAlcubierre :: report ( const vec4 , const vec4 , std::string &text )
{
    std::stringstream ss;
 ...
 */
void 
MetricAlcubierre :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 0.0;
    mInitPos[2] = -10.0;
 ...
 */
double 
MetricAlcubierre :: calcRs ( const double* pos )
{
    double t = pos[0];
    double x = pos[1];
    double y = pos[2];
...
double 
MetricAlcubierre :: calcF  ( const double* pos )
{
...
void 
MetricAlcubierre :: calcDF ( const double* pos, double &ft, double &fx, double &fy, double &fz )
{ 
    double rs = calcRs(pos);
#if 1
...
void
MetricAlcubierre :: calcD2F ( const double* pos, double &ftt, double &ftx, double &fty, double &ftz,
