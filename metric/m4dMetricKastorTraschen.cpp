...
bool
MetricKastorTraschen :: calculateMetric( const double* pos )
{
    double Omega,a;
...
bool 
MetricKastorTraschen :: calculateChristoffels  ( const double* pos )
{
    double Omega,a;
...
bool 
MetricKastorTraschen :: calculateChrisD ( const double*  )
{
    return false;
    /*
 ...
 */
void
MetricKastorTraschen :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricKastorTraschen :: coordToLocal ( const double* pos, const double* cdir, double* ldir,
                                       enum_nat_tetrad_type   )
{
    double Omega,a;
    calcPotentials(pos,Omega,a);
 ...
 */
bool 
MetricKastorTraschen :: breakCondition ( const double* )
{
    bool br = false;
    return br;
}
...
double
MetricKastorTraschen :: testConstraint ( const double y[], const double kappa )
{
    double Omega,a;
 ...
 */
bool 
MetricKastorTraschen :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricKastorTraschen :: report ( const vec4 , const vec4 , std::string &text )
{
    std::stringstream ss;
...
void
MetricKastorTraschen::calcPotentials( const double* pos, double &Omega, double &a ) {
    double t = pos[0];
    double x = pos[1];
    double y = pos[2];
    double z = pos[3];
...
void
MetricKastorTraschen::calcPotDiffs( const double* pos, double &Omega, double &a,
 ...
 */
void 
MetricKastorTraschen :: setStandardValues( )
{
    mInitPos[0] = 0.0;
    mInitPos[1] = 30.0;
    mInitPos[2] = 0.0;
