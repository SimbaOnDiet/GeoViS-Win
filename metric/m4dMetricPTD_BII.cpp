 ...
 */
bool
MetricPTD_BII :: calculateMetric  ( const double* pos )
{
    double r     = pos[1];
    double z     = pos[3];
    double b = Par_b;
 ...
 */
bool
MetricPTD_BII :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];
    double b = Par_b;
 ...
 */
bool
MetricPTD_BII :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double z = pos[3];
    double b = Par_b;
 ...
 */
void
MetricPTD_BII :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPTD_BII :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type )
{
    double r = pos[1];
    double z = pos[3];
 ...
 */
bool
MetricPTD_BII :: breakCondition ( const double* pos)
{
    bool br = false;
...
/*! Set parameter 'pName' to 'val'.
         ...
         */
bool
MetricPTD_BII :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricPTD_BII :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
void
MetricPTD_BII :: setStandardValues( )
{
  mInitPos[0] = 0.0;
