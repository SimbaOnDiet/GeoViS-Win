 ...
 */
bool 
MetricTaubNUT :: calculateMetric  ( const double* pos )
{
    //double r     = pos[1];
    double theta = pos[2];
    double l = mL;
 ...
 */
bool 
MetricTaubNUT :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
    double M = mMass;
 ...
 */
bool 
MetricTaubNUT :: calculateChrisD ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
  double M = mMass;
 ...
 */
void
MetricTaubNUT :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricTaubNUT :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                enum_nat_tetrad_type   )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool 
MetricTaubNUT :: breakCondition ( const double* pos)
{
  bool br = false;

  double r = pos[1];
  double delta = r*r - 2.0*mMass*r - mL*mL;
  if (fabs(delta)<1e-12) br=true;
  return br;
}
...
bool
MetricTaubNUT :: calcDerivs ( const double y[], double dydx[] )
{
  return false;
  dydx[0] = y[4];
  dydx[1] = y[5];
 ...
 */
double 
MetricTaubNUT :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
bool 
MetricTaubNUT :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricTaubNUT :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricTaubNUT :: totEnergy ( const vec4 pos, const vec4 cdir, const double , double &val )
{
 ...
 */
bool    
MetricTaubNUT :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricTaubNUT :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 6.0;
  mInitPos[2] = M_PI_2;
 ...
 */
void
MetricTaubNUT :: calcCriticalRadius  ( )
{
