 ...
 */
bool
MetricPTD_AI :: calculateMetric  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
    double b = Par_b;
 ...
 */
bool
MetricPTD_AI :: calculateChristoffels  ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
    double b = Par_b;
 ...
 */
bool
MetricPTD_AI :: calculateChrisD ( const double* pos )
{
    double r     = pos[1];
    double theta = pos[2];
    double b = Par_b;
 ...
 */
void
MetricPTD_AI :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPTD_AI :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                 enum_nat_tetrad_type   )
{
    double r     = pos[1];
    double theta = pos[2];
 ...
 */
bool
MetricPTD_AI :: breakCondition ( const double* pos)
{
    bool br = false;

    if ((pos[1]<0.0) || (pos[1]<=(1.0+eps)*Par_b)) { br=true; }
    return br;
}
 ...
 */
void
MetricPTD_AI :: calcConstantsOfMotion (const vec4 pos, const vec4 cdir)
{
 ...
 */
bool
MetricPTD_AI :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type , const double x, double &val )
{
    /*
    double kappa = 0.0;
 ...
 */
bool
MetricPTD_AI :: totEnergy ( const vec4 , const vec4 , const double , double &val )
{
    val = 0.0;
    return true;
}
 ...
 */
bool
MetricPTD_AI :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricPTD_AI :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
    std::stringstream ss;
 ...
 */
void
MetricPTD_AI :: setStandardValues( )
{
    mInitPos[0] = 0.0;
