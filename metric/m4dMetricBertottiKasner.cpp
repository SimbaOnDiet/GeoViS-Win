 ...
 */
bool 
MetricBertottiKasner :: calculateMetric  ( const double* pos )
{
  double t     = pos[0];
  double theta = pos[2];
  ...
  g_compts[0][3] = 0.0;
  g_compts[1][0] = 0.0;
  g_compts[1][1] = exp(2.0*sqrt(mLambda)*c*t);
  g_compts[1][2] = 0.0;
  g_compts[1][3] = 0.0;
  g_compts[2][0] = 0.0;
  g_compts[2][1] = 0.0;
  g_compts[2][2] = 1.0/mLambda;
  g_compts[2][3] = 0.0;
  g_compts[3][0] = 0.0;
  g_compts[3][1] = 0.0;
  g_compts[3][2] = 0.0;
  g_compts[3][3] = sin(theta)*sin(theta)/mLambda;
 ...
 */
bool 
MetricBertottiKasner :: calculateChristoffels  ( const double* pos )
{
   double t     = pos[0];
   double theta = pos[2];
   ...
   christoffel[1][0][1] = c*sl;
   christoffel[1][0][2] = 0.0;
   christoffel[1][0][3] = 0.0;
   christoffel[1][1][0] = sl/c*exp(2.0*sl*c*t);
 ...
 */
bool 
MetricBertottiKasner :: calculateChrisD ( const double* pos )
{
   double t     = pos[0];
   double theta = pos[2];
   ...
   chrisD[1][0][3][2] = 0.0;
   chrisD[1][0][3][3] = 0.0;
   chrisD[1][1][0][0] = 2.0*mLambda*exp(2.0*sl*c*t);
   chrisD[1][1][0][1] = 0.0;
   chrisD[1][1][0][2] = 0.0;
   chrisD[1][1][0][3] = 0.0;
   chrisD[1][1][1][0] = 0.0;
   ...
   chrisD[2][3][3][0] = 0.0;
   chrisD[2][3][3][1] = 0.0;
   chrisD[2][3][3][2] = -pow(sin(theta),-2.0);
   chrisD[2][3][3][3] = 0.0;
   chrisD[3][0][0][0] = 0.0;
   chrisD[3][0][0][1] = 0.0;
   chrisD[3][0][0][2] = 0.0;
   ...
   chrisD[3][2][3][0] = 0.0;
   chrisD[3][2][3][1] = 0.0;
   chrisD[3][2][3][2] = -pow(sin(theta),-2.0);
   chrisD[3][2][3][3] = 0.0;
   chrisD[3][3][0][0] = 0.0;
   chrisD[3][3][0][1] = 0.0;
   chrisD[3][3][0][2] = 0.0;
 ...
 */
void
MetricBertottiKasner :: localToCoord   ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricBertottiKasner :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                         enum_nat_tetrad_type   )
{
  double t     = pos[0];
  double theta = pos[2];
 ...
 */
bool 
MetricBertottiKasner :: breakCondition ( const double* )
{
  return false;
}
 ...
 */
double 
MetricBertottiKasner :: testConstraint ( const double y[], const double kappa )
{
  double t     = y[0];
  double theta = y[2];
 ...
 */
bool 
MetricBertottiKasner :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricBertottiKasner :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
  ...
  ss << "  Lambda ........................... " << mLambda << std::endl;

  double h1 = exp(2.0*sqrt(mLambda)*pos[0])*cdir[1];
 ...
 */
void 
MetricBertottiKasner :: setStandardValues( )
{
  mInitPos[0] = -1.0;
  mInitPos[1] = 1.0;
  mInitPos[2] = M_PI_2;
