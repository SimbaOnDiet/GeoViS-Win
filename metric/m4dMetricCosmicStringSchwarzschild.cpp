 ...
 */
bool 
MetricCosmicStringSchwarzschild :: calculateMetric  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricCosmicStringSchwarzschild :: calculateChristoffels  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricCosmicStringSchwarzschild :: calculateChrisD ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricCosmicStringSchwarzschild :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void 
MetricCosmicStringSchwarzschild :: coordToLocal ( const double* pos, const double* cdir, double* ldir,
                                            enum_nat_tetrad_type  )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricCosmicStringSchwarzschild :: breakCondition ( const double* pos)
{
  bool br = false;
 ...
 */
bool 
MetricCosmicStringSchwarzschild :: calcDerivs ( const double y[], double dydx[] )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
double 
MetricCosmicStringSchwarzschild :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
bool   
MetricCosmicStringSchwarzschild :: calcProduct ( const double* pos, const double* u, const double* v, double &prod, bool )
{
  prod = 0.0;
 ...
 */
bool 
MetricCosmicStringSchwarzschild :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricCosmicStringSchwarzschild :: transToTwoPlusOne  ( vec4 p, vec4 &cp )
{
  vec4 tp;
 ...
 */
bool
MetricCosmicStringSchwarzschild :: transToEmbedding ( vec4 p, vec4 &ep )
{
  vec4 cp;
 ...
 */
bool
MetricCosmicStringSchwarzschild :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool
MetricCosmicStringSchwarzschild :: testEmbeddingParams  ( )
{
  bool allOk = true;
  if (mEmb_rmin<rs)
  {
 ...
 */
int
MetricCosmicStringSchwarzschild :: getEmbeddingVertices ( std::vector<vec3> &verts,
 ...
 */
bool
MetricCosmicStringSchwarzschild :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricCosmicStringSchwarzschild :: totEnergy ( const vec4 pos, const vec4 cdir, const double , double &val )
{
  if (pos[1]<rs+1e-2)
      return false;
 ...
 */
bool    
MetricCosmicStringSchwarzschild :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
bool
MetricCosmicStringSchwarzschild :: calcKsiCrit ( const vec4 pos, double &ksicrit )
{
  if (pos[1]<rs)
    return false;
 ...
 */
void 
MetricCosmicStringSchwarzschild :: setStandardValues( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 3.0*rs;
  mInitPos[2] = M_PI_2;
 ...
 */
double
MetricCosmicStringSchwarzschild :: embFunc ( const double r )
{
    double z = 0.0;
