 ...
 */
bool 
MetricPainleveGullstrand :: calculateMetric  ( const double* pos )
{  
  double r     = pos[1];
  double theta = pos[2];
  ...
  double t2 = 1/r;
  double t4 = c*c;
  double t7 = sqrt(rs*t2);
  double t8 = c*t7;
  double t9 = r*r;
  double t10 = sin(theta);
  double t11 = t10*t10;
      
	  g_compts[0][0] = -(-rs+r)*t2*t4;
      g_compts[0][1] = t8;
      g_compts[0][2] = 0.0;
      g_compts[0][3] = 0.0;
      g_compts[1][0] = t8;
 ...
 */
bool 
MetricPainleveGullstrand :: calculateChristoffels  ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
  ...
  double t30 = t26*t26;
      ...
      christoffel[0][0][1] = t10/t5/r*t14*rs/2.0;
      christoffel[0][0][2] = 0.0;
      christoffel[0][0][3] = 0.0;
      christoffel[0][1][0] = t18;
      ...
      christoffel[1][0][0] = t18;
      christoffel[1][0][1] = -t9;
      christoffel[1][0][2] = 0.0;
      christoffel[1][0][3] = 0.0;
      christoffel[1][1][0] = t19/t3*t7/2.0;
      christoffel[1][1][1] = -t18;
      ...
      christoffel[2][2][0] = -t24*r;
      christoffel[2][2][1] = -t10;
      ...
      christoffel[3][3][0] = -t24*r*t30;
      christoffel[3][3][1] = -t10*t30;
 ...
 */
bool
MetricPainleveGullstrand :: calculateChrisD ( const double* pos )
{
  double r     = pos[1];
  double theta = pos[2];
  ...
  double t9 = 1/t8;
  double t10 = t6*t9;
  double t12 = 5.0/4.0*c*t4*t10;
  double t13 = c*c;
  double t23 = rs/t7/r;
  double t24 = 1/c;
  double t30 = 1/t7;
  double t31 = t24*t4;
  double t34 = cos(theta);
  double t35 = t34*t34;
  double t36 = sin(theta);
  double t37 = t36*t36;
  double t40 = (t35+t37)/t37;
      ...
      chrisD[0][0][0][3] = 0.0;
      chrisD[0][0][1][0] = 0.0;
      chrisD[0][0][1][1] = -t13*rs*(2.0*r-3.0*rs)*t9/2.0;
      chrisD[0][0][1][2] = 0.0;
      chrisD[0][0][1][3] = 0.0;
      chrisD[0][0][2][0] = 0.0;
      chrisD[0][0][2][1] = 0.0;
      ...
      chrisD[1][0][3][3] = 0.0;
      chrisD[1][1][0][0] = 0.0;
      chrisD[1][1][0][1] = -3.0/4.0*t24/t3/t2*t10;
      chrisD[1][1][0][2] = 0.0;
      chrisD[1][1][0][3] = 0.0;
      chrisD[1][1][1][0] = 0.0;
      chrisD[1][1][1][1] = t23;
      ...
      chrisD[3][2][3][3] = 0.0;
      chrisD[3][3][0][0] = 0.0;
      chrisD[3][3][0][1] = -t31*t1*t37*rs/2.0;
      chrisD[3][3][0][2] = -2.0*t24*t3*r*t36*t34;
      chrisD[3][3][0][3] = 0.0;
      chrisD[3][3][1][0] = 0.0;
      chrisD[3][3][1][1] = -t37;
      chrisD[3][3][1][2] = -2.0*(-rs+r)*t36*t34;
      chrisD[3][3][1][3] = 0.0;
      chrisD[3][3][2][0] = 0.0;
      chrisD[3][3][2][1] = 0.0;
      chrisD[3][3][2][2] = -t35+t37;
      chrisD[3][3][2][3] = 0.0;
      chrisD[3][3][3][0] = 0.0;
      chrisD[3][3][3][1] = 0.0;
      chrisD[3][3][3][2] = 0.0;
 ...
 */
void
MetricPainleveGullstrand :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void 
MetricPainleveGullstrand :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                           enum_nat_tetrad_type  type )
{
  double r     = pos[1];
  double theta = pos[2];  
 ...
 */
bool 
MetricPainleveGullstrand :: breakCondition ( const double* pos)
{
  bool br = false;
  
  if (pos[1]<0.0) { br=true; }
  return br;
}
 ...
 */
double 
MetricPainleveGullstrand :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
  ...
  double sum = -kappa;  
  sum += -dT*dT + pow(dr+sqrt(rs/r)*dT,2.0) + r*r*(dth*dth + sin(theta)*sin(theta)*dph*dph);  
  return sum;
}
 ...
 */
bool 
MetricPainleveGullstrand :: setParam ( std::string pName, double val )
{
 ...
 */
bool    
MetricPainleveGullstrand :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricPainleveGullstrand :: setStandardValues ( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 3.0*rs;
  mInitPos[2] = M_PI_2;
