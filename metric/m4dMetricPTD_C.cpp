 ...
 */
bool
MetricPTD_C :: calculateMetric  ( const double* pos )
{
  double x = pos[2];
  double y = pos[3];
  double a = Par_a;
 ...
 */
bool
MetricPTD_C :: calculateChristoffels  ( const double* pos )
{
    double x = pos[2];
    double y = pos[3];
    double a = Par_a;
 ...
 */
void
MetricPTD_C :: localToCoord ( const double* pos, const double* ldir, double* dir,
 ...
 */
void
MetricPTD_C :: coordToLocal   ( const double* pos, const double* cdir, double* ldir,
                                           enum_nat_tetrad_type )
{
    double x = pos[2];
    double y = pos[3];
 ...
 */
bool
MetricPTD_C :: breakCondition ( const double* )
{
    bool br = false;
  /*
    double x = pos[2];
 ...
 */
double
MetricPTD_C :: testConstraint ( const double y[], const double kappa )
{
    calculateMetric(y);
 ...
 */
bool
MetricPTD_C :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricPTD_C :: report ( const vec4 , const vec4 , std::string &text )
{
  std::stringstream ss;
