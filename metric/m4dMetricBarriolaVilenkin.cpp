 ...
 */
bool 
MetricBarriolaVilenkin :: calculateMetric ( const double* pos )
{
  double r = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricBarriolaVilenkin :: calculateChristoffels  ( const double* pos )
{
  double r = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricBarriolaVilenkin :: calculateChrisD ( const double* pos )
{
  double r = pos[1];
  double theta = pos[2];
 ...
 */
void
MetricBarriolaVilenkin :: localToCoord ( const double* pos, const double* ldir, double* dir, 
 ...
 */
void
MetricBarriolaVilenkin :: coordToLocal ( const double* pos, const double* cdir, double* ldir, 
                                         enum_nat_tetrad_type   )
{
  double r     = pos[1];
  double theta = pos[2];
 ...
 */
bool 
MetricBarriolaVilenkin :: breakCondition ( const double* )
{
  return false;
}
 ...
 */
bool 
MetricBarriolaVilenkin :: calcDerivs ( const double y[], double dydx[] )
{
  dydx[0] = y[4];
  dydx[1] = y[5];
  dydx[2] = y[6];
 ...
 */
double 
MetricBarriolaVilenkin :: testConstraint ( const double y[], const double kappa )
{
  double r     = y[1];
  double theta = y[2];
 ...
 */
bool 
MetricBarriolaVilenkin :: setParam ( std::string pName, double val )
{
 ...
 */
bool
MetricBarriolaVilenkin :: transToEmbedding ( vec4 p, vec4 &ep )
{
  vec4 cp;
 ...
 */
bool
MetricBarriolaVilenkin :: setEmbeddingParam    ( std::string name, double val )
{
 ...
 */
bool
MetricBarriolaVilenkin :: testEmbeddingParams  ( )
{
  bool allOk = true;
  if (mEmb_rmin<0.0)
  {
 ...
 */
int
MetricBarriolaVilenkin :: getEmbeddingVertices ( std::vector<vec3> &verts,
 ...
 */
bool
MetricBarriolaVilenkin :: effPotentialValue  ( const vec4 pos, const vec4 cdir ,enum_geodesic_type type, const double x, double &val )
{
  double kappa = 0.0;
 ...
 */
bool
MetricBarriolaVilenkin :: totEnergy ( const vec4 , const vec4 cdir, const double , double &val )
{
  // 1/2*k^2/c^2:
 ...
 */
bool    
MetricBarriolaVilenkin :: report ( const vec4 pos, const vec4 cdir, std::string &text )
{
  std::stringstream ss;
 ...
 */
void 
MetricBarriolaVilenkin :: setStandardValues ( )
{
  mInitPos[0] = 0.0; 
  mInitPos[1] = 10.0;
  mInitPos[2] = M_PI_2;
 ...
 */
double
MetricBarriolaVilenkin :: closestApproach ( const vec4 pos, const vec4 cdir )
{
   double h2 = mk*mk*pos[1]*pos[1]*cdir[3];
   double h1 = mSpeedOfLight*mSpeedOfLight*cdir[0];
