; Definitions especially for GeoViS
(define gpObjTypeLocal 0)
(define gpObjTypeInCoords 1)

(define gpCSGDifferObj 1)
(define gpCSGUnifiedObj 2)
(define gpCSGIntersecObj 3)
...
(define gpDBLMAX 1.844674407370955616e19)
...
;;;  define by Th.Mueller
;;;
;;;  Source: Bronstein
;;; --------------------------------
(define (asinh a) (log (+ a (sqrt (+ (* a a) 1)))))
(define (acosh a) (log (+ a (sqrt (- (* a a) 1)))))
(define (atanh a) (* 0.5 (log (/ (+ 1 a) (- 1 a)))))
(define (acoth a) (* 0.5 (log (/ (+ a 1) (- a 1)))))

(define (Heaviside a) (if (or (> a 0) (= a 0)) 1 0))
