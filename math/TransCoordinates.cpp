 ...
 */
void
TransCoordinates :: toCartesianCoord ( enum_coordinate_type fromCoord, const vec4& oldPos,
                                       vec4& newPos )      
{
  switch ( fromCoord )
  {
 ...
 */
void
TransCoordinates :: toCartesianCoord ( enum_coordinate_type fromCoord, const vec4& oldPos, const vec4& oldDir,
 ...
 */
void
TransCoordinates :: toCartesianCoord ( enum_coordinate_type fromCoord, const std::vector<vec4>& oldPos,
 ...
 */
void
TransCoordinates :: toCartesianCoord ( enum_coordinate_type fromCoord, const std::vector<vec4>& oldPos, const std::vector<vec4>& oldDir,
 ...
 */
void
TransCoordinates :: coordTransf ( enum_coordinate_type fromCoord, const vec4& oldPos,
 ...
 */
void
TransCoordinates :: coordTransf ( enum_coordinate_type fromCoord, const vec4& oldPos, const vec4& oldDir,
 ...
 */
void 
TransCoordinates :: coordTransf ( enum_coordinate_type fromCoord, const std::vector<vec4>& oldPos,
 ...
 */
void 
TransCoordinates :: coordTransf ( enum_coordinate_type fromCoord, const std::vector<vec4>& oldPos, const std::vector<vec4>& oldDir,
 ...
 */
void
TransCoordinates :: transCoordCartSph ( const vec4& oldPos, vec4& newPos )
{
  ...
  if ( x==0.0 && y==0.0 )
  {
    ...
    if ( z==0.0 )
      theta = M_PI_2;
    newPos = vec4(t,fabs(z),theta,0.0);
  ...
  if (z>0.0 || z<0.0)
    tan_theta = sqrt( (x*x+y*y)/(z*z) ) ;
  if (z>0.0)
    theta = atan(tan_theta);
  else if (z<0.0)
    theta = M_PI-atan(tan_theta);
  else if (z==0.0)
    theta = 0.5*M_PI;
 ...
 */
void 
TransCoordinates :: transCoordCartSph ( const vec4& oldPos, const vec4& oldDir,
                                        vec4& newPos, vec4& newDir )
{
 ...
 */
void 
TransCoordinates :: transCoordCartSph ( const vec4& oldPos, const vec4& oldDir0, const vec4& oldDir1, const vec4& oldDir2, const vec4& oldDir3,
 ...
 */
void 
TransCoordinates :: transCoordSphCart ( const vec4& oldPos, vec4& newPos )
{
  double t     = oldPos[0];
  double r     = oldPos[1];
 ...
 */
void
TransCoordinates :: transCoordSphCart( const vec4& oldPos, const vec4& oldDir,
                                       vec4& newPos, vec4& newDir )
{
  double r     = oldPos[1];
  double theta = oldPos[2];
 ...
 */
void
TransCoordinates :: transCoordSphCart ( const vec4& oldPos, const vec4& oldDir0, const vec4& oldDir1, const vec4& oldDir2, const vec4& oldDir3,
                                        vec4& newPos, vec4& newDir0, vec4& newDir1, vec4& newDir2, vec4& newDir3 )
{
  double r     = oldPos[1];
  double theta = oldPos[2];
 ...
 */
void
TransCoordinates :: transCoordCartCyl ( const vec4& oldPos, vec4& newPos )
{
  double t = oldPos[0];
  double x = oldPos[1];
  double y = oldPos[2];
 ...
 */
void
TransCoordinates :: transCoordCartCyl( const vec4& oldPos, const vec4& oldDir,
                                        vec4& newPos, vec4& newDir )
{
 ...
 */
void
TransCoordinates :: transCoordCartCyl( const vec4& oldPos, const vec4& oldDir0, const vec4& oldDir1, const vec4& oldDir2, const vec4& oldDir3,
                                       vec4& newPos, vec4& newDir0, vec4& newDir1, vec4& newDir2, vec4& newDir3 )
{
  transCoordCartCyl(oldPos,newPos);
  double r     = newPos[1];
 ...
 */
void 
TransCoordinates :: transCoordCylCart ( const vec4& oldPos, vec4& newPos )
{
  double t   = oldPos[0];
  double r   = oldPos[1];
  double phi = oldPos[2];
 ...
 */
void
TransCoordinates :: transCoordCylCart( const vec4& oldPos, const vec4& oldDir,
                                       vec4& newPos, vec4& newDir )
{
  double r     = oldPos[1];
  double phi   = oldPos[2];
 ...
 */
void
TransCoordinates :: transCoordCylCart( const vec4& oldPos, const vec4& oldDir0, const vec4& oldDir1, const vec4& oldDir2, const vec4& oldDir3,
                                       vec4& newPos, vec4& newDir0, vec4& newDir1, vec4& newDir2, vec4& newDir3 ) 
{
  double r     = oldPos[1];
  double phi   = oldPos[2];
