...
//-------------------------------------------------------------------------
//   Zylindergleichung:  x^2 + y^2 - 1 = 0                                 
//   Strahl:  x = x1*t + x0                                                
//            y = y1*t + y0                                                
//   Schnitt: a*t^2 + b*t + c = 0                                          
//       mit: a = x1*x1 + y1*y1,                                           
//            b = 2*(x1*x0 + y1*y0),                                       
//            c = x0*x0 + y0*y0 - 1                                        
//   Loesung: t = (-b +-sqrt(b*b - 4*a*c)) / (2a)                          
//              = (-b/2 +-sqrt((b/2)^2 - ac)) / a                          
//-------------------------------------------------------------------------
bool 
...
//-------------------------------------------------------------------------
//   algorithm: A. Glassner, An Indroduction to Ray Tracing, p. 75
//-------------------------------------------------------------------------
// Changed 19980311 by Daniel Weiskopf for correct texture mapping
// on bottom and top faces
